                                ...
                                function getRow(id) {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            $('#edit_package').val(response.package);
                                            $('#edit_finalproduct').val(response.finalproduct);
