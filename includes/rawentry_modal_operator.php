    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Recording Entries</h5>
            ...
            <div class="modal-body">
                ...
                <!-- Saving modal -->
                <form class="row g-3" action="saverawentry_operator.php" method="POST" id="save_member">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><label>Unit Price</label>
                                    <input type="number" name="sprice[]" required class="form-control" style="width: 8em;" value="0" readonly>
...
<div class="modal fade" id="delete" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="delete_rawentry_operator.php">
...
<div class="modal fade" id="edit" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Products Entry Edit</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              
                <form class="row g-3" action="edit_rawentry_operator.php" method="POST" id="save_member">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" name="quantity" class="form-control" placeholder="Enter Quantity" autocomplete="off" id="edit_quantity" style="width:8em">
                      
                    </div>
                    <div class="col-md-4">
                    <label for="inputState" class="form-label">Unit Price</label>

                    <input type="number" name="sprice" class="form-control" placeholder="Unit Price" autocomplete="off" id="edit_sprice" style="width:8em" readonly>
                    </div>
                    <div class="col-md-12">
