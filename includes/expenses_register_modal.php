    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Saving modal -->
                <form class="row g-3" action="save_expenses_register.php" method="POST" id="save_member">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <datalist id="datalist1">
                                        ...
                                        $query2 = mysqli_query($con, "select * from expenses order by rawItem asc");
...
<div class="modal fade" id="delete" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="delete_expenses_register.php">
...
<div class="modal fade" id="edit" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Saving modal -->
                <form action="edit_expenses_register.php" method="POST" id="save_member">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" name="item" id="edit_expense" list="datalist2" autocomplete="off">
