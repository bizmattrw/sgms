<div class="modal fade" id="addnew" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Credits Entry</h5>
      ...
      <script type="text/javascript" src="script.js"></script> 
        ...
        <!-- Saving modal -->
        <form class="row g-3" action="savecredit.php" method="POST" id="save_member">
  ...
  <td><label>Amount</label>
                              <input type="text" name="amount[]"  required class="form-control" style="width:10em;font-weight:bold;color:blue">
  
                           </td>
                           <td><label>Interest Rate</label>
                              <input type="text" name="rate[]"  required class="form-control" style="width:5em;font-weight:bold;color:blue">
...
<div class="modal fade" id="delete" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="delete_credit.php">
...
<div class="modal fade" id="edit" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Credits Edit</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <!-- Saving modal -->
        <form class="row g-3" action="edit_credit.php" method="POST" id="save_member">
