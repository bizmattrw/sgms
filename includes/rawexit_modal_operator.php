    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <!-- Saving modal -->
                <form class="row g-3" action="saverawexit_operator.php" method="POST" id="save_member">
...
<div class="modal fade" id="delete" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="delete_rawexit_operator.php">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="row g-3" action="edit_rawexit_operator.php" method="POST" id="save_member">
