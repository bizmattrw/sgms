    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Expenses Registration</h5>
            ...
            <div class="modal-body">
                ...
                <!-- Saving modal -->
                <form class="row g-3" action="saveexpenses.php" method="POST" id="save_member">
...
<div class="modal fade" id="delete" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="delete_expenses.php">
...
<div class="modal fade" id="edit" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Saving modal -->
                <form class="row g-3" action="edit_expenses.php" method="POST" id="save_member">
