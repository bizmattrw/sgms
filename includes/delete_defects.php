...
if (isset($_POST['delete'])) {
    ...
    $id = $_POST['id1'];
    $query1 = mysqli_query($con, "select rawmaterial,quantity as qty from defects where id='$id'") or die(mysqli_error($con));
    ...
    $k = mysqli_query($con, "delete from defects where id='$id'") or die(mysqli_error($con));
    if ($k) {
