                                ...
                                function getRow(id) {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            $('#edit_names').val(response.rawItem);
