                                ...
                                function getRow(id) {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            $('#edit_rawmaterial').val(response.rawmaterial);
                                            $('#edit_previtem').val(response.rawmaterial);
                                            $('#edit_quantity').val(response.quantity);
                                            $('#edit_prevqty').val(response.quantity);
