                            ...
                            <script>
                                $(document).ready(function() {
                                    $('#customer_data').DataTable({
                                        ...
                                        'serverMethod': 'post',
                                        'ajax': {
                                            'url': 'packagesexitapprovalajax.php'
                                        },
                                        'columns': [{
                                                data: 'id'
                                            },
		...
		if (el.value == "") {
			...
			xmlhttp.onreadystatechange = function() {
				if (this.readyState == 4 && this.status == 200) {
					...
					pu.value = data.sprice
					type.value = data.type;
				}
			};
			xmlhttp.open("GET","packagesexitstock.php?q="+el.value, true);
			xmlhttp.send();
		}
	}
