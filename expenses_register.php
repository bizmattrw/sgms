                            ...
                            <script>
                                $(document).ready(function() {
                                    $('#customer_data').DataTable({
                                        ...
                                        'serverMethod': 'post',
                                        'ajax': {
                                            'url': 'expenses_register_ajax.php'
                                        },
                                        'columns': [{
                                                data: 'id'
                                            },
                                ...
                                function getRow(id) {
                                    $.ajax({
                                        ...
                                        success: function(response) {
                                            ...
                                            $('#edit_expense').val(response.expense);
                                            $('#edit_quantity').val(response.amount);
